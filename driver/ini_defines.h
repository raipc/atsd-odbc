...
#define INI_URL TEXT("Url")           /* Full url of server running the ATSD service */
#define INI_SERVER TEXT("Server")     /* Name of Server running the ATSD service */
...
#define INI_PORT TEXT("Port")         /* Port on which the ATSD is listening */
